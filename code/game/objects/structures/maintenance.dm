...
/obj/structure/moisture_trap/attack_hand(mob/user, list/modifiers)
	...
	if(hidden_item)
		...
		to_chat(user, span_notice("当你在[src]内摸索时，你感觉到浑浊的水面下隐藏着某物的轮廓。</span>\n<span class='nicegreen'>你从[hidden_item]中取出了[src]。"))
		hidden_item = null
		return
...
/obj/structure/destructible/cult/pants_altar
	name = "奇怪的结构"
	desc = "这是个什么? 谁把它放在站点上的? 还有为啥它在散发<span class='hypnophrase'>奇怪能量?</span>"
	icon_state = "altar"
...
/obj/structure/steam_vent/fast
	desc = "一个能定期过滤出附近墙壁和窗户上水汽分子的装置。只在水汽捕获装置附近起效。比同类装置效率更高。"
