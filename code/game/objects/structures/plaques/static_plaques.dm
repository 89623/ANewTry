...
/obj/structure/plaque/static_plaque/golden/commission/efficiency
	desc = "旋臂星区空间站 SS-07\n'效率'级前哨站\nCommissioned 启用日期 28/01/2556\nDecommissioned 停用日期 20/12/2556\n'更聪明地工作，而不是更努力'"
...
/obj/structure/sign/plaques/kiddie/devils_tooth
	...
	desc = "一块纪念那些在挖掘围绕这颗冰封星球的隧道时不幸牺牲的灵魂们的纪念牌匾。被命名为 \"恶魔之牙\"，因为那些献出生命之人肯定觉得他们身处地狱。"
