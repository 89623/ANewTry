/obj/item/food/sandwich
	name = "三明治"
	desc = "一份由肉、奶酪、面包和几片生菜组成的伟大创造！亚瑟·登特会为此感到骄傲的。"
...
/obj/item/food/sandwich/notasandwich
	name = "非三明治"
	desc = "这东西似乎有点不对劲，你不太确定是什么。也许是因为他的小胡子。"
...
/obj/item/food/danish_hotdog
	name = "丹麦热狗"
	desc = "诱人的面包，中间夹着一根香肠，覆盖着酱汁、炸洋葱和腌黄瓜圈"
	icon = 'icons/obj/food/meat.dmi'
...
/obj/item/food/sandwich/peanut_butter_banana
	name = "花生酱香蕉三明治"
	desc = "花生酱三明治中混入了香蕉片，是一种不错的高蛋白零食。"
...
/obj/item/food/sandwich/philly_cheesesteak
	...
	desc = "一种流行的三明治，由切片肉、洋葱、融化的奶酪夹在长条潜艇面包中制成。光是“令人垂涎”都不足以形容它。"
...
/obj/item/food/sandwich/toast_sandwich
	name = "吐司三明治"
	desc = "两片面包中间夹着一片涂了黄油的烤吐司。你为什么要做这个？"
...
/obj/item/food/sandwich/death/examine(mob/user)
	...
	if(check_liked(user) == FOOD_LIKED)
		return
	to_chat(user, span_warning("你想象自己吃下[src]。你突然感到嘴里一阵酸味，以及一种可怕的、自己做错了事的感觉。"))
...
/obj/item/food/sandwich/death/suicide_act(mob/living/user)
	user.visible_message(span_suicide("[user]开始把[src]以错误的方式塞进[user.p_their()]喉咙。看起来[user.p_theyre()]想要自杀！"))
	qdel(src)
	user.gib()
