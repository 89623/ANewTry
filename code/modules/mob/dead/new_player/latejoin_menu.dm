	...
	for(var/datum/job_department/department as anything in SSjob.joinable_departments)
		...
		for(var/datum/job/job_datum as anything in department.department_jobs)
			...
			var/list/job_data = list(
				...
				"display_name" = localized_job_title(job_datum.title),
			)
...
/datum/latejoin_menu/ui_static_data(mob/user)
	...
	for(var/datum/job_department/department as anything in SSjob.joinable_departments)
		...
		var/list/department_data = list(
			...
			"display_name" = localized_department_name(department.department_name),
		)
		departments[department.department_name] = department_data
...
/datum/latejoin_menu/ui_act(action, list/params, datum/tgui/ui, datum/ui_state/state)
	...
	switch(action)
		...
		if("select_job")
			log_game("LATEJOIN DEBUG: ui_act select_job raw=[params["job"]] user=[key_name(owner)]")
