...
/datum/emote/living/custom/proc/get_custom_emote_from_user()
	return stripped_multiline_input(usr, "选择一个要显示的表情。", "我" , null, MAX_MESSAGE_LEN) // NOVA EDIT CHANGE - ORIGINAL : return copytext(sanitize(input("Choose an emote to display.") as text|null), 1, MAX_MESSAGE_LEN)
