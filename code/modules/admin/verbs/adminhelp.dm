...
/datum/admin_help/proc/Reject(key_name = key_name_admin(usr))
	...
	if(initiator)
		...
		to_chat(initiator, "<font color='red' size='4'><b>- 管理员求助已拒绝！ -</b></font>", confidential = TRUE)
		to_chat(initiator, "<font color='red'><b>你的管理员求助已被拒绝。</b>adminhelp 动词已返还给你，以便你可以重试。</font>", confidential = TRUE)
...
/client/verb/no_tgui_adminhelp(message as message)
	set name = "NoTguiAdminhelp-非TGUI的Ahelp"
	set hidden = TRUE
...
/client/verb/adminhelp()
	set category = "Admin"
	set name = "Adminhelp-管理员帮助"
	GLOB.admin_help_ui_handler.ui_interact(mob)
	to_chat(src, span_boldnotice("管理员求助无法打开或工作？<a href='byond://?src=[REF(src)];tguiless_adminhelp=1'>点击这里</a>"))

/client/verb/view_latest_ticket()
	set category = "Admin"
	set name = "View Latest Ticket-查看最新票"
