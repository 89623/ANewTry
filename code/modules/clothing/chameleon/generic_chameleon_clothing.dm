...
/obj/item/clothing/glasses/chameleon
	...
	desc = "供工程与采矿人员使用，可在任何光照条件下透视墙壁，查看基本结构与地形布局。"
	icon_state = "meson"
...
/obj/item/clothing/mask/chameleon
	name = "防毒面具"
	desc = "一种能连接供气系统的面部遮盖面具。虽然能很好地隐藏身份，但对阻隔气体流动效果不佳。" //More accurate
	icon_state = "gas_alt"
...
/obj/item/clothing/mask/chameleon/attack_self(mob/user)
	...
	on = !on
	to_chat(user, span_notice("变声器现已[on ? "on" : "off"]！"))
...
/obj/item/clothing/mask/chameleon/drone/attack_self(mob/user)
	to_chat(user, span_notice("[src]没有配备变声器。"))
