...
/datum/round_event/supermatter_surge/announce(fake)
	...
	priority_announce("晶体完整性监控系统检测到超物质室存在异常大气特性，超物质晶体的能量输出已显著增加。需要工程部介入以稳定引擎。", "等级 [class_to_announce] 超物质涌动警报", 'sound/machines/engine_alert/engine_alert3.ogg')
...
/datum/round_event/supermatter_surge/poly/announce(fake)
	priority_announce("晶体完整性监控系统检测到超物质室存在异常的鹦鹉型共振，超物质晶体的能量输出已显著增加。需要工程部介入以稳定引擎。", "晶体完整性监测系统检测到超物质舱内出现异常的鹦鹉型共振，超物质晶体的能量输出显著增加。需要工程部门介入以稳定引擎。", 'sound/machines/engine_alert/engine_alert3.ogg')
