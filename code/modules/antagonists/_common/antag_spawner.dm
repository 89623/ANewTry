...
/obj/item/antag_spawner/contract/proc/poll_for_student(mob/living/carbon/human/teacher, apprentice_school)
	...
	polling = TRUE
	var/mob/chosen_one = SSpolling.poll_ghosts_for_target("您想扮演[span_danger("[teacher]'s")][span_notice("[apprentice_school] apprentice")]吗？", check_jobban = ROLE_WIZARD, role = ROLE_WIZARD, poll_time = 15 SECONDS, checked_target = src, alert_pic = /obj/item/clothing/head/wizard/red, jump_target = src, role_name_text = "巫师学徒", chat_text_border_icon = /obj/item/clothing/head/wizard/red)
	polling = FALSE
