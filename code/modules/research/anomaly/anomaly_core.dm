...
/obj/item/assembly/signaler/anomaly/vortex
	...
	desc = "涡旋异常的中和核心。它没有静止，就好像有某种无形的力量作用在它身上。这可能很有研究价值。"
...
/obj/item/assembly/signaler/anomaly/bioscrambler
	...
	desc = "生物扰频器异常的中和核心。它在蠕动，好像在移动。这可能很有研究价值。"
...
/obj/item/assembly/signaler/anomaly/hallucination
	name = "\improper 生物扰乱异常核心"
	desc = "一种幻觉异常的中和核心。它似乎在移动，但很可能只是你的想象而已。它或许对研究很有价值。"
...
/obj/item/assembly/signaler/anomaly/dimensional
	...
	desc = "这是一个维度异常的核心。其表面反射出的物体看起来不太正常。它或许对研究工作很有价值。"
