...
/obj/item/paper/guides/jobs/engi/solars
	name = "纸张 - “走向绿色！自行搭建太阳能阵列的操作指南。”"
	default_raw_text = "<h1>欢迎</h1><p>在绿洲公司，我们热爱环境，也热爱太空。通过这套工具包，您将能够帮助大自然母亲，在不使用任何化石燃料或等离子体的情况下生产能源！奇点能源是危险的，而太阳能是安全的，这就是为什么它更好。现在，以下是设置您自己的太阳能阵列的方法。</p><p>您可以通过将太阳能组件用扳手固定在电缆节点上来制作太阳能板。添加一块玻璃板，任何非强化玻璃都可以，即可完成太阳能板的建造。就是这么简单！</p><p>在再设置好19块这样的太阳能板后，您会想要创建一个太阳追踪器来追踪大自然母亲的馈赠——太阳。步骤与之前相同，只是在执行添加玻璃的最后一步之前，需要将追踪器设备电路插入组件中。现在您有了一个追踪器！最后一步是添加一台计算机来计算太阳的运动，并向太阳能板发送指令以使其随太阳改变方向。设置太阳能计算机与设置任何其他计算机相同，所以您应该能轻松完成。您需要在计算机下方放置一个电线节点，并且电线需要连接到追踪器。</p><p>恭喜您，您应该拥有一个正常工作的太阳能阵列了。如果您遇到困难，这里有一些提示。确保所有太阳能设备（包括计算机）都位于电缆节点上。如果您犯了错误，随时可以拆除您的作品。</p><p>就是这样，注意安全，保持绿色！</p>"
