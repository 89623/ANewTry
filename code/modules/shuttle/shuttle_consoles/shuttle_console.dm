...
/obj/machinery/computer/shuttle/ui_act(action, list/params, datum/tgui/ui, datum/ui_state/state)
	...
	switch(action)
		...
		if("request")
			...
			to_chat(GLOB.admins, "<b>穿梭机：<font color='#3d5bc3'>[ADMIN_LOOKUPFLW(usr)] (<A href='byond://?_src_=holder;[HrefToken()];move_shuttle=[shuttleId]'>移动穿梭机</a>)(<A href='byond://?_src_=holder;[HrefToken()];unlock_shuttle=[REF(src)]'>锁定/解锁穿梭机</a>)</b>正在请求移动或解锁穿梭机。</font>")
			return TRUE
