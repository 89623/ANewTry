...
/datum/glass_style/drinking_glass/fernet
	...
	name = "一杯菲奈特"
	desc = "一杯纯菲奈特。只有绝对的疯子才会单独喝这个。" //Hi Kevum
...
/datum/glass_style/drinking_glass/pruno
	...
	name = "一杯普诺酒"
	desc = "用水果、糖和绝望发酵而成的监狱私酿酒。安保最喜欢没收这个，这也是安保部门唯一做过的好事。"
...
/datum/glass_style/drinking_glass/yuyake
	...
	name = "一杯夕烧酒"
	desc = "这是70年代甜蜜的精髓，装在杯子里……当然是1970年代！"
	icon = 'icons/obj/drinks/drinks.dmi'
