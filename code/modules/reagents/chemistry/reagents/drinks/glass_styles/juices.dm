...
/datum/glass_style/drinking_glass/toechtauese_juice
	...
	name = "一杯托赫陶斯果汁"
	desc = "未经加工、未掺假的托赫陶斯果汁。喝上一口就会让你充满悔意。"
