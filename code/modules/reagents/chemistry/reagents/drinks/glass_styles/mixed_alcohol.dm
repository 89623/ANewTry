...
/datum/glass_style/drinking_glass/gintonic
	...
	name = "金汤力"
	desc = "一款温和但仍很棒的鸡尾酒。像个真正的英国人那样一饮而尽吧。"
	icon = 'icons/obj/drinks/mixed_drinks.dmi'
...
/datum/glass_style/drinking_glass/white_russian
	...
	name = "白俄罗斯人"
	desc = "一杯看起来非常棒的饮料。但这只是，嗯，你的个人看法，伙计。"
	icon = 'icons/obj/drinks/mixed_drinks.dmi'
...
/datum/glass_style/drinking_glass/screwdrivercocktail
	...
	name = "螺丝起子"
	desc = "伏特加和橙汁的简单而卓越的混合物。正是疲惫工程师所需。"
	icon = 'icons/obj/drinks/mixed_drinks.dmi'
...
/datum/glass_style/drinking_glass/longislandicedtea
	...
	name = "长岛冰茶"
	desc = "酒柜里的酒，混合成一杯美味的饮品。仅供中年酗酒女性享用。"
	icon = 'icons/obj/drinks/mixed_drinks.dmi'
...
/datum/glass_style/drinking_glass/fetching_fizz
	...
	name = "吸引之泡"
	desc = "能诱发饮用者的磁性。起初是酒吧里的恶作剧，后来演变成深受矿工和废料回收者喜爱的饮品。有金属余味。"
	icon = 'icons/obj/drinks/mixed_drinks.dmi'
...
/datum/glass_style/drinking_glass/narsour
	...
	name = "纳尔酸酒"
	desc = "一款受THE ARM酿酒厂启发的新潮鸡尾酒，能让你立刻高喊“Fuu ma'jin”！"
	icon = 'icons/obj/drinks/mixed_drinks.dmi'
	icon_state = "narsour"
...
/datum/glass_style/drinking_glass/creme_de_cacao
	...
	name = "可可甜酒"
	desc = "数以百万计的欺凌诉讼和酒精中毒事件都始于这种不起眼的原料。"
...
/datum/glass_style/drinking_glass/quadruple_sec
	...
	name = "四倍君度"
	desc = "一种令人生畏且合法的饮料，挑衅你去违法并让它得逞。不过，执勤时仍然不能喝。"
	icon = 'icons/obj/drinks/mixed_drinks.dmi'
...
/datum/glass_style/drinking_glass/amaretto_alexander
	...
	name = "杏仁亚历山大"
	desc = "一款奶油般、令人放纵的美味，事实上正如它看起来那般温和。"
	icon = 'icons/obj/drinks/mixed_drinks.dmi'
...
/datum/glass_style/drinking_glass/between_the_sheets
	...
	name = "床笫之间"
	desc = "唯一一款附带标签提醒你纳米传讯公司零容忍滥交政策的饮品。"
	icon = 'icons/obj/drinks/mixed_drinks.dmi'
...
/datum/glass_style/drinking_glass/fernet_cola
	...
	name = "一杯菲奈特可乐"
	desc = "一个锯断的可乐瓶，里面装满了菲奈特可乐。在像头肥猪一样大吃一顿后，没有比这更好的了。"
	icon = 'icons/obj/drinks/mixed_drinks.dmi'
...
/datum/glass_style/drinking_glass/branca_menta
	...
	name = "一杯布兰卡薄荷"
	desc = "一杯布兰卡薄荷，非常适合那些慵懒而炎热的周日下午。" //Get lazy literally by drinking this
...
/datum/glass_style/drinking_glass/planet_cracker
	...
	name = "行星粉碎者"
	desc = "尽管历史学家认为这款饮品最初是为了纪念人类过去一场重要冲突的结束而创造的，但其起源已基本被遗忘，如今它更多地被视为人类至高无上地位的普遍象征。"
	icon = 'icons/obj/drinks/mixed_drinks.dmi'
...
/datum/glass_style/drinking_glass/pina_colada
	...
	name = "椰林飘香"
	desc = "如果你喜欢椰林飘香，也喜欢淋雨……那么，你会喜欢这款饮品。"
	icon = 'icons/obj/drinks/mixed_drinks.dmi'
...
/datum/glass_style/drinking_glass/pina_olivada
	...
	name = "橄榄椰林飘香"
	desc = "果味菠萝与浓稠、醇厚的橄榄油的平衡。饮用前请充分搅拌。"
...
/datum/glass_style/drinking_glass/ginger_amaretto
	...
	name = "姜汁杏仁酒"
	desc = "迷迭香枝为饮品增添了宜人的香气，毕竟不只是为了装腔作势！"
	icon = 'icons/obj/drinks/mixed_drinks.dmi'
...
/datum/glass_style/drinking_glass/godfather
	...
	name = "教父"
	desc = "来自旧意大利的经典，深受黑帮喜爱，祈祷橙皮不会掉进你嘴里。"
	icon = 'icons/obj/drinks/mixed_drinks.dmi'
...
/datum/glass_style/drinking_glass/sea_breeze
	...
	name = "海风"
	desc = "薄荷味、巧克力味、奶油味。就像可以喝的薄荷巧克力片！"
	icon = 'icons/obj/drinks/mixed_drinks.dmi'
...
/datum/glass_style/drinking_glass/the_juice
	...
	name = "果汁"
	desc = "一种由不那么可食用的东西调制而成的混合物，据说能让你感觉同时身处两地"
	icon = 'icons/obj/drinks/mixed_drinks.dmi'
	icon_state = "thejuice"
...
/datum/glass_style/drinking_glass/long_john_silver
	...
	name = "长腿约翰·西尔弗"
	desc = "以一位著名的海盗命名，他可能是虚构的，也可能不是。不过，嘿，为什么要让真相妨碍一个好故事呢？" //Chopper Reid says "How the fuck are ya?"
	icon = 'icons/obj/drinks/mixed_drinks.dmi'
...
/datum/glass_style/drinking_glass/pod_tesla
	...
	name = "豆荚特斯拉"
	desc = "驾驭闪电！能为以太族充电，抑制恐惧症，并赋予强大的临时电击抗性。"
	icon = 'icons/obj/drinks/mixed_drinks.dmi'
...
/datum/glass_style/drinking_glass/saibasan
	...
	name = "Saibāsan"
	desc = "为纪念赛博阳光工业连续经营600周年而调制的饮品。在纳米传讯的空间站上，官方要求你称其为“香港酷乐”，但这名字糟透了。"
	icon = 'icons/obj/drinks/mixed_drinks.dmi'
	icon_state = "saibasan"
...
/datum/glass_style/drinking_glass/sanraizusoda
	...
	name = "Sanraizusōda"
	desc = "一种源自日本的流行儿童甜点，加入烈酒后变成了成人饮品。干杯！"
	icon = 'icons/obj/drinks/mixed_drinks.dmi'
...
/datum/glass_style/drinking_glass/kumicho
	...
	name = "Kumichō"
	desc = "就像美国的“教父”一样，组长鸡尾酒精致、浓烈，并且几乎肯定与非法活动有关。"
	icon = 'icons/obj/drinks/mixed_drinks.dmi'
	icon_state = "kumicho"
...
/datum/glass_style/drinking_glass/red_planet
	...
	name = "红色星球"
	desc = "一种来自火星的爱国饮品，通常在9月15日享用：这一天，在火星起义后宣布了和平，火星让步协议使火星作为地球联邦的一部分获得了适当的代表权。"
	icon = 'icons/obj/drinks/mixed_drinks.dmi'
...
/datum/glass_style/drinking_glass/nekomimosa
	...
	name = "Nekomimosa"
	desc = "一种糖浆般混乱的鸡尾酒，献给几年前风靡火星的一位猫人流行歌星。"
	icon = 'icons/obj/drinks/mixed_drinks.dmi'
...
/datum/glass_style/drinking_glass/sentai_quencha
	...
	name = "战队解渴饮"
	desc = "尝起来像是终极忍者之力。还有蜜瓜味。还有柑橘味。以及一些其他东西。"
	icon = 'icons/obj/drinks/mixed_drinks.dmi'
...
/datum/glass_style/drinking_glass/bosozoku
	...
	name = "Bōsōzoku"
	desc = "一种在火星及其他地区广受欢迎的清爽夏日饮品。与任何沙迪或拉德勒啤酒的相似之处纯属巧合。"
	icon = 'icons/obj/drinks/mixed_drinks.dmi'
	icon_state = "bosozoku"
...
/datum/glass_style/drinking_glass/ersatzche
	...
	name = "Ersatzche"
	desc = "一种有趣的饮品，发明于新大阪的蓝室酒吧与烧烤店。这是对墨西哥特帕切酒的一种美味改良，以啤酒为基底。"
	icon = 'icons/obj/drinks/mixed_drinks.dmi'
...
/datum/glass_style/drinking_glass/red_city_am
	...
	name = "红城晨光"
	desc = "新大阪酒吧里流行的早餐饮品——专为有进取心的日间饮酒者准备。"
	icon = 'icons/obj/drinks/mixed_drinks.dmi'
...
/datum/glass_style/drinking_glass/kings_ransom
	...
	name = "国王的赎金"
	desc = "一种奇特的饮品，成功地将多种看似冲突的风味融合成一种和谐的口感。"
	icon = 'icons/obj/drinks/mixed_drinks.dmi'
...
/datum/glass_style/drinking_glass/white_hawaiian
	...
	name = "白色夏威夷"
	desc = "白色俄罗斯的无数变体之一，这款饮品摆脱了冰封北地的束缚，带着一系列烤椰子风味，进入了火环带的炽热之中。"
	icon = 'icons/obj/drinks/mixed_drinks.dmi'
...
/datum/glass_style/drinking_glass/imperial_mai_tai
	...
	name = "帝国迈泰"
	desc = "我是说，这年头谁还会买杏仁糖浆啊？科塔坚果才是新潮流，宝贝。"
	icon = 'icons/obj/drinks/mixed_drinks.dmi'
...
/datum/glass_style/drinking_glass/boston_sour
	...
	name = "波士顿酸酒"
	desc = "威士忌酸酒的经典变体，使用蛋清来提供口感和结构。尽管有些人说蛋清不会被威士忌的酒精消毒，但如果鸡蛋处理得当，可能也没问题……"
	icon = 'icons/obj/drinks/mixed_drinks.dmi'
...
/datum/glass_style/drinking_glass/star
	...
	name = "星辰"
	desc = "这款鸡尾酒将质朴的苹果白兰地与甜味美思精炼融合。无论是在果园中还是在庄园内，都同样令人舒适。"
	icon = 'icons/obj/drinks/mixed_drinks.dmi'
	icon_state = "star"
...
/datum/glass_style/drinking_glass/sazerac
	...
	name = "萨泽拉克"
	desc = "一款来自新奥尔良的经典鸡尾酒，使用克里奥尔风格的苦精，并用苦艾酒冲洗酒杯，赋予其令人愉悦的茴芹香气。"
	icon = 'icons/obj/drinks/mixed_drinks.dmi'
	icon_state = "sazerac"
...
/datum/glass_style/drinking_glass/amaretto_sour
	...
	name = "杏仁酸酒"
	desc = "这款对酸酒配方的甜美演绎，因其坚果与蛋类的风味而在提兹里安受众中广受欢迎。只要不是素食主义者，它仍然非常适合大多数人的口味。"
	icon = 'icons/obj/drinks/mixed_drinks.dmi'
...
/datum/glass_style/drinking_glass/ramos_gin_fizz
	...
	name = "拉莫斯金菲士"
	desc = "这款鸡尾酒犯下了将柑橘与奶油混合的禁忌，但通过恰当的手法避免了凝结，并创造出美妙质感的泡沫层。以美味、创新和制作过程极其烦人而闻名。"
	icon = 'icons/obj/drinks/mixed_drinks.dmi'
...
/datum/glass_style/drinking_glass/french_75
	...
	name = "法兰西75"
	desc = "以20世纪初法军使用的野战炮命名，这款优雅的香槟鸡尾酒在历史上几经变化，但其唤起胜利的能力始终如一。"
	icon = 'icons/obj/drinks/mixed_drinks.dmi'
...
/datum/glass_style/drinking_glass/sangria
	...
	name = "桑格利亚"
	desc = "为炎炎夏日准备的葡萄酒潘趣酒。但愿其制作过程中不涉及放血。"
	icon = 'icons/obj/drinks/mixed_drinks.dmi'
	icon_state = "sangria"
...
/datum/glass_style/drinking_glass/suffering_bastard
	...
	name = "受苦的混蛋"
	desc = "最初是为远离家乡的士兵准备的解酒药，后来融入了提基美学，这款饮品具有缓解头痛和安抚胃部的神奇功效。"
	icon = 'icons/obj/drinks/mixed_drinks.dmi'
...
/datum/glass_style/drinking_glass/blue_blazer
	...
	name = "蓝色火焰"
	desc = "由鸡尾酒调酒之父之一创造的视觉震撼饮品，通过在两杯之间抛掷燃烧的威士忌制成。室外温度超过华氏五十度时不宜供应，不过在空间站上这倒不是什么大问题。"
	icon = 'icons/obj/drinks/mixed_drinks.dmi'
...
/datum/glass_style/drinking_glass/hot_toddy
	...
	name = "热托蒂"
	desc = "将你从所处的任何零下地狱般的寒冷中暂时抽离，哪怕只有片刻。"
	icon = 'icons/obj/drinks/mixed_drinks.dmi'
...
/datum/glass_style/drinking_glass/tizirian_sour
	...
	name = "提兹里安酸酒"
	desc = "从特立尼达到多巴哥再到提兹里亚，像这样以苦精作为基酒的鸡尾酒相当罕见。"
	icon = 'icons/obj/drinks/mixed_drinks.dmi'
