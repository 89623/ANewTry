...
/datum/glass_style/drinking_glass/berry_blast
	...
	name = "浆果爆破思慕雪"
	desc = "一款经典饮品，用亲手采摘的浆果新鲜制成。或者，也许不是。"
	icon = 'icons/obj/drinks/shakes.dmi'
...
/datum/glass_style/drinking_glass/funky_monkey
	...
	name = "时髦猴子思慕雪"
	desc = "一款用巧克力和香蕉制成的经典饮品。官方声明，没有猴子受到伤害。"
	icon = 'icons/obj/drinks/shakes.dmi'
