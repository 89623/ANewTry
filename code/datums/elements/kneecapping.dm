...
/datum/element/kneecapping/proc/do_kneecap_target(obj/item/weapon, obj/item/bodypart/leg, mob/living/carbon/target, mob/attacker)
	...
	attacker.visible_message(span_warning("[attacker] 仔细瞄准[attacker.p_their()]的[weapon]，准备挥向[target]的膝盖！"), span_danger("You carefully aim \the [weapon] for a swing at [target]'s kneecaps!"))
	...
	attacker.visible_message(span_warning("[attacker] 挥舞着[attacker.p_their()]的[weapon]砸向[target]的膝盖！"), span_danger("You swing \the [weapon] at [target]'s kneecaps!"))
