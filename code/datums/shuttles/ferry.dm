...
/datum/map_template/shuttle/ferry/base
	suffix = "base"
	name = "运输摆渡船"
	description = "标准配置的Box/Metastation中央司令部穿梭渡船。"
...
/datum/map_template/shuttle/ferry/fancy
	suffix = "fancy"
	name = "豪华运输摆渡船"
	description = "不知何时，有人升级了渡船，铺上了更华丽的地板……并且减少了座位。"

/datum/map_template/shuttle/ferry/kilo
	suffix = "kilo"
	name = "千吨级运输摆渡船"
	description = "Kilo型空间站的标准配置中央司令部穿梭渡船。包含额外设备和充电器。"

/datum/map_template/shuttle/ferry/northstar
	suffix = "northstar"
	name = "北极星运输摆渡船"
	description = "在边疆的最深处，你需要一艘坚固的穿梭机来运送船员，这就是那艘。"

/datum/map_template/shuttle/ferry/nebula
	suffix = "nebula"
	name = "星云运输渡轮"
	description = "一艘适合在微风中优雅旅行的好渡船。配有充电器。"
