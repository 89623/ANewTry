...
/mob/living/proc/boxing_help()
	set name = "专注于你的架势"
	set desc = "你专注于如何最大限度地发挥你的拳击架势。"
	set category = "Boxing"
	to_chat(usr, "<b><i>你专注于自己的架势，想象着如何最好地挥出一拳。</i></b>")

	to_chat(usr, "<b><i>你所施展的招式取决于你点击的鼠标按键，以及最后一次点击的按键是否与你出拳时选定的手相匹配。</i></b>")
	...
	to_chat(usr, "<b><i>在投掷模式下，你可以格挡来袭的拳头，并对攻击者返还少量伤害。以此方式格挡攻击会使你损失一些耐力。</i></b>")

	to_chat(usr, "<b><i>你的拳击能力仅能对其他拳击手使用。</i></b>")
...
/mob/living/proc/evil_boxing_help()
	set name = "专注格斗"
	set desc = "你思索着如何最好地重塑敌人的面孔。"
	set category = "Evil Boxing"
	to_chat(usr, "<b><i>你沉思着即将到来的暴力，想象着如何最好地挥出一拳。</i></b>")
...
/mob/living/proc/hunter_boxing_help()
	set name = "专注狩猎"
	set desc = "你专注于如何最有效地痛揍另一种濒危物种。"
	set category = "Hunter Boxing"
	to_chat(usr, "<b><i>你专注于你的拳头。你专注于冒险。你专注于狩猎。</i></b>")
	...
	to_chat(usr, "<b><i>在投掷模式下，你可以格挡来袭的拳头，并对攻击者返还少量伤害。以此方式格挡攻击会使你损失一些耐力。</i></b>")
	to_chat(usr, "<b><i>连续打出有效的连击可以恢复你的一些生命值并造成更多伤害。</i></b>")

	to_chat(usr, "<b><i>你的猎人拳击能力仅能用于对抗这个宇宙中存在的各种植物、动物和非自然生物。面对正常类人生物时，你只是一名拳击手。</i></b>")
