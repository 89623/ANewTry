...
/mob/living/proc/CQC_help()
	...
	set category = "CQC"
	to_chat(usr, "<b><i>你试图回忆一些CQC的基础知识。</i></b>")

	to_chat(usr, "[span_notice("Slam")]：抓取后出拳。将对手猛摔在地，使其倒地。")
	to_chat(usr, "[span_notice("CQC Kick")]：连续出拳。将对手击退。击晕已眩晕的对手并造成耐力伤害。")
	to_chat(usr, "[span_notice("Restrain")]：连续抓取。将对手锁入束缚姿势，使用解除武装动作可通过锁喉使其昏迷。")
	to_chat(usr, "[span_notice("Pressure")]：推搡后抓取。造成可观的耐力伤害。")
