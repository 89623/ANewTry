...
/datum/map_template/ruin/space/asteroid5
	...
	name = "太空遗迹-小行星5"
	description = "哦，我的天啊，又一块巨大的岩石！"

/datum/map_template/ruin/space/asteroid6
	id = "asteroid6"
	suffix = "asteroid6.dmm"
	name = "太空遗迹-小行星6"
	description = "这颗小行星患有脆骨病，幸好小行星没有骨头。"
...
/datum/map_template/ruin/space/derelict3
	...
	name = "太空遗迹-废弃设施3"
	description = "这些残骸曾是更大结构的一部分，三大\[已编辑\]在那里被锻造。"
...
/datum/map_template/ruin/space/derelict5
	...
	name = "太空遗迹-废弃设施5"
	description = "计划是这样的：我们把一大堆装满财宝的板条箱放进这个废弃的仓库，发射到太空，然后永远忽略它。"
...
/datum/map_template/ruin/space/mech_transport
	...
	name = "太空遗迹-CF海盗船"
	description = "好吧，它什么时候到？我有账单要付；那些全副武装的客户希望他们的货物越快越好！我不管，快找到它！"
...
/datum/map_template/ruin/space/spacehotel
	...
	name = "太空遗迹-双生枢纽酒店"
	description = "一家星际酒店，疲惫的太空人可以在此歇脚放松，确信住店员工不会在他们睡觉时谋杀他们。大概吧。"

/datum/map_template/ruin/space/turreted_outpost
	id = "turreted-outpost"
	suffix = "turretedoutpost.dmm"
	name = "太空遗迹-无名炮塔前哨站"
	description = "我们想让他们别再放那俄国流行音乐了，但我们谁都没胆量靠近他们那些死亡炮塔。"

/datum/map_template/ruin/space/oldshuttle
	id = "spaceman-origins"
	suffix = "shuttlerelic.dmm"
	name = "太空遗迹-奇异飞船"
	description = "一艘似乎迷失了方向，在群星间漂流的飞船。这东西看起来像是属于远古时代的。"

/datum/map_template/ruin/space/way_home
	id = "way-home"
	suffix = "way_home.dmm"
	name = "太空遗迹-救赎"
	description = "在最黑暗的时刻，我们将找到回家的路。"
...
/datum/map_template/ruin/space/thederelict
	...
	name = "太空遗迹-科斯米切斯卡亚站13"
	description = "科斯米切斯卡亚13号空间站的真实命运至今仍是一个未解之谜。大多数公司都否认它的存在，唯恐被问及其船员的遭遇。"
...
/datum/map_template/ruin/space/oldteleporter
	...
	name = "太空遗迹-分离的传送器"
	description = "这个保存得惊人的完好传送器的结构表明，它曾经是一个更大结构的一部分，但该结构的剩余部分（如果有的话）只能靠猜测了。"
...
/datum/map_template/ruin/space/gondoland
	...
	name = "太空遗迹-贡多兰"
	description = "只是一块普通的岩石——等等，那是什么东西？"
...
/datum/map_template/ruin/space/whiteshipdock
	...
	name = "太空遗迹-白船码头"
	description = "一艘废弃但功能完好的飞船，停泊在深空之中，唾手可得。"
...
/datum/map_template/ruin/space/hilbertresearchfacility
	...
	name = "太空遗迹-希尔伯特研究设施"
	description = "一个取得重大蓝空发现的研究设施。早已被遗弃，无论自愿与否……"

/datum/map_template/ruin/space/clownplanet
	id = "clownplanet"
	suffix = "clownplanet.dmm"
	name = "太空遗迹-小丑星球"
	description = "这颗小行星被认为在2552年就已失踪，但最近被重新发现了。"

/datum/map_template/ruin/space/clericden
	id = "clericden"
	suffix = "clericden.dmm"
	name = "太空遗迹-牧师巢穴"
	description = "这里曾是一座更大修道院的一部分，这个早已消亡的牧师圣团所行的非暴力之道远少于他们所宣扬的。然而，此地似乎未被掠夺者染指。真奇怪。"

/datum/map_template/ruin/space/forgottenship
	id = "forgottenship"
	suffix = "forgottenship.dmm"
	name = "太空遗迹-辛迪加遗忘之船"
	description = "一艘看似被遗弃的飞船偏离航线，径直闯入了纳米传讯控制的空域。似乎是故障导致除冬眠舱外的大部分系统关闭。"
...
/datum/map_template/ruin/space/film_studio
	...
	name = "太空遗迹-太空扇区13本地频道"
	description = "一个服务于13号太空星区周边地区的本地电视台，节目包括但不限于：脱口秀、歌剧、舞台剧等等！"
...
/datum/map_template/ruin/space/experimental_cloning
	...
	name = "太空遗迹-实验性克隆设施"
	description = "一个研究站的碎片，内含一个功能尚可的克隆设备。"
