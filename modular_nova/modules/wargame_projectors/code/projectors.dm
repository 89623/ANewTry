...
/obj/item/wargame_projector/proc/create_hologram(atom/target, mob/user, list/modifiers)
	...
	if(LAZYACCESS(modifiers, ICON_X) && LAZYACCESS(modifiers, ICON_Y))
		click_x = clamp(text2num(LAZYACCESS(modifiers, ICON_X)) - 16, -(ICON_SIZE_X/2), ICON_SIZE_X/2)
		click_y = clamp(text2num(LAZYACCESS(modifiers, ICON_Y)) - 16, -(ICON_SIZE_Y/2), ICON_SIZE_Y/2)
...
/obj/item/wargame_projector/ships
	name = "全息单位投影仪"
	desc = "由纳米传讯海军司令部开发，用于进行兵棋推演的便捷全息投影仪，这个用于创建'单位'标记。"
...
/obj/item/wargame_projector/terrain
	name = "全息地形投影仪"
	desc = "一款由纳米传讯海军司令部开发的便捷全息投影仪，用于进行战争游戏，这个型号可以创建太空'地形'标记。"
	flags_1 = parent_type::flags_1 | NO_NEW_GAGS_PREVIEW_1
	max_signs = 30
