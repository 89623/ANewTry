/obj/item/gun/ballistic/revolver/ocelot
	name = "柯尔特和平缔造者左轮手枪"
	desc = "一款改装过的和平缔造者左轮手枪，使用.357弹药。威力比常规.357小，但跳弹次数多得多。" // We need tension...conflict. The world today has become too soft. We're living in an age where true feelings are suppressed. So we're going to shake things up a bit. We'll create a world dripping with tension... ...a world filled with greed and suspicion, bravery and cowardice.
